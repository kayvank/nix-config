...
myKeys conf@(XConfig {XMonad.modMask = modm}) =
  M.fromList $
    ...
    [ ((noModMask, xF86XK_AudioLowerVolume), spawn "amixer -D pulse sset Master on && amixer -D pulse sset Master 5%- && ogg123 /home/baerg/Sounds/volume.ogg"),
      ...
      ((noModMask, xF86XK_MonBrightnessUp), spawn "/home/kayvan/bin/brightness-up"),
      ((noModMask, xF86XK_MonBrightnessDown), spawn "/home/kayvan/bin/brightness-down"),
      ...
      -- Swap the focused window and the master window ((modm, xK_Return), windows W.swapMaster),
